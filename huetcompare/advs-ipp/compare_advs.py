...
def main(tense,name1,name2,nameout):
 ...
 statusnames = ["ROOT HAS SAME FORMS IN %s and %s"%(name1.upper(),name2.upper()),
  "%s FORMS < %s FORMS"%(name1.upper(),name2.upper()),
  "%s FORMS > %s FORMS"%(name1.upper(),name2.upper()),
  "DIFFERENT FORMSQ",
  "ROOT IN %s ONLY" % name2.upper(),
  "ROOT IN %s ONLY" % name1.upper()
 ]
 outrecs = []
 istem = 0
