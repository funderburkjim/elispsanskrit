...
kledayizyamARa pfut Af:[kledayizyamARA kledayizyamARe kledayizyamARAH kledayizyamARAm kledayizyamARe kledayizyamARAH kledayizyamARayA kledayizyamARAByAm kledayizyamARABiH kledayizyamARAyE kledayizyamARAByAm kledayizyamARAByaH kledayizyamARAyAH kledayizyamARAByAm kledayizyamARAByaH kledayizyamARAyAH kledayizyamARayoH kledayizyamARAnAm kledayizyamARAyAm kledayizyamARayoH kledayizyamARAsu nil nil nil]
  """
...
def pysan_parse(line):
 ...
 elif key1.endswith('A'):
  stem = key1[0:-1] + 'a' # change final 'A' to 'a'
  stemtabs = [(stem,tabstr)]
 else:
  print "problem with feminine stem:",line
  exit(1)
