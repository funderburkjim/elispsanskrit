""" comparea_class_pada.py
    Aug 31, 2016
    restrict attention to cases where Huet spells a root with and
    ending 'a', and MW has the root without an 'a'
"""
import sys
...
def main(name1,name2,nameout):
 ...
 fout=open(fileout,"w")
 #fout.write('; Huet class pada # MW class pada\n')
 for out in outarr:
  fout.write(out + "\n")
